...
public class CustomerPreLoadConfiguration {
    ...
    public void insertInitialH2Data() throws ParseException {
        try {
            ...
            c1.setUser(this.createFakeLogin("josilva","josilva@bol.com", User.PersonType.JURÍDICA));
            ...
            c2.setUser(this.createFakeLogin("loverboy", "diegoferques33@bol.com", User.PersonType.FÍSICA));
            ...
            c3.setUser(this.createFakeLogin("madores", "madores@bol.com", User.PersonType.FÍSICA));
            ...
            c4.setUser(this.createFakeLogin("fernandacal", "fecal@bol2.com", User.PersonType.JURÍDICA));
            ...
            c5.setUser(this.createFakeLogin("diegoferequest","diegoferques@bol.com", User.PersonType.FÍSICA));
