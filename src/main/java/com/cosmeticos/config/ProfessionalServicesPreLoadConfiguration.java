...
public class ProfessionalServicesPreLoadConfiguration {
    ...
    public void insertInitialH2Data(){
        ...
        Service s2 = serviceRepository.findWithSpecialties(2L);
        ...
        Service s3 = serviceRepository.findWithSpecialties(3L);
        ...
        Service s4 = serviceRepository.findWithSpecialties(4L);
        ...
        Service s5 = serviceRepository.findWithSpecialties(5L);
