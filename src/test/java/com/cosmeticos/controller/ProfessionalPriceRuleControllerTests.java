...
public class ProfessionalPriceRuleControllerTests {
    ...
    public void testPutRuleForProfessional1() throws URISyntaxException {
        ...
        Professional persistentProfessional = professionalRepository.findById(professional.getIdProfessional());
    ...
    public void testOvewritePutRuleForProfessionalWith2Rules() throws URISyntaxException {
        ...
        Professional persistentProfessional2 = professionalRepository.findById(professional.getIdProfessional());
    ...
    public void testPutRuleForProfessionalRemoving1Rule() throws URISyntaxException {
        ...
        Professional persistentProfessional3 = professionalRepository.findById(professional.getIdProfessional());
    ...
    public void testRuleIgualEntreProfessional() throws URISyntaxException {
        ...
        Professional persistentProfessional2 = professionalRepository.findById(professional2.getIdProfessional());
